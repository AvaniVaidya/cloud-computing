...
def handle(req):
    data = {
        ...
        "attachments": [{
            ...
            "author_name": "Avani Vaidya",
            "author_icon": "https://avatars.githubusercontent.com/u/52353707?v=4",
            "image_url": "https://hub.docker.com/repository/docker/avaidya2/slack-request/general"
        },
        {
